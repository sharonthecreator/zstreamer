...
#define PWM_SINK_DEFINE(inst)                                                                      \
	...
	DEVICE_DT_INST_DEFINE(inst, zstreamer_sink_common_init, NULL, &pwm_sink_data_##inst,       \
			      &pwm_sink_config_##inst, POST_KERNEL,                                \
			      CONFIG_KERNEL_INIT_PRIORITY_DEVICE, &pwm_sink_api);
