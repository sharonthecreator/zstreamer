...
#define NUMGEN_SRC_DEFINE(inst)                                                                    \
	...
	DEVICE_DT_INST_DEFINE(inst, zstreamer_source_common_init, NULL, &numgen_src_data_##inst,   \
			      &numgen_src_config_##inst, POST_KERNEL,                              \
			      CONFIG_KERNEL_INIT_PRIORITY_DEVICE, &numgen_src_api);
