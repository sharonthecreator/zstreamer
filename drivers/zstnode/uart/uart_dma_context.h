 ...
 * This module provides a shared context so both zstsrc-uart (RX) and
 * zstsink-uart (TX) can use async/DMA on the same UART.
 */

#ifndef ZSTNODE_UART_DMA_CONTEXT_H_
#define ZSTNODE_UART_DMA_CONTEXT_H_
...
#endif /* ZSTNODE_UART_DMA_CONTEXT_H_ */
